                ...
                <div class="col-md-6 col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" action="{{ url('banner/' .$banner->id. '/' .$spanduk) }}" method="POST"
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 form-group">
                                                ...
                                                <img src="{{ asset('assets/images/banner/' .$spanduk. '/' . $banner->gambar )}}" alt="" width="300vh">
                                            </div>
                                            <div class="col-md-4">
                                                <label>Status</label>
                                            </div>
